...
xLabels<-c("Sequential", "Seq.AVX2", "Parallel", "Parallel AVX2", "MKL", "compact", "scatter", "Parallel 2", "Parallel 3", "Parallel 4", "Profil")
...
wvioplot(seq$V1, seqavx$V1,par1$V1,par1avx$V1, mkl$V1, compact$V1, scatter$V1, par2$V1, par3$V1, par4$V1, profil$V1, clip=TRUE, adjust = 1, col=palette[1],names=FALSE)

axis(1,cex.axis=0.6,at=1:11, labels=xLabels)
