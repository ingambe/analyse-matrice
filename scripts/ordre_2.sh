...
do
  ...
  echo "GCC \n"
  #GCC
  ./../bin/gcc_ordre2_O3.out >> ../output/ordre2/gcc/O3/resultat.txt

  echo "INTEL \n"
  #INTEL
  ./../bin/intel_ordre2_O3.out >> ../output/ordre2/intel/O3/resultat.txt

  echo "CLANG \n"
  #CLANG
  ./../bin/clang_ordre2_O3.out >> ../output/ordre2/clang/O3/resultat.txt
done
