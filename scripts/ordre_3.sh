...
do
  ...
  echo "GCC \n"
  #GCC
  ./../bin/gcc_ordre3_O3.out >> ../output/ordre3/gcc/O3/resultat.txt

  echo "INTEL \n"
  #INTEL
  ./../bin/intel_ordre3_O3.out >> ../output/ordre3/intel/O3/resultat.txt

  echo "CLANG \n"
  #CLANG
  ./../bin/clang_ordre3_O3.out >> ../output/ordre3/clang/O3/resultat.txt
done
